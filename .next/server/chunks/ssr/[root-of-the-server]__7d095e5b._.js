...
/* __next_internal_action_entry_do_not_use__ [{"4096c2780ef739260885f3e920f21d927fbc5d22a3":"createInvoice","60095a287f5a2aeb47940ed8be0bcbd2cd06adb072":"updateInvoice"},"",""] */ __turbopack_context__.s({
    "createInvoice": (()=>createInvoice),
    "updateInvoice": (()=>updateInvoice)
});
...
async function updateInvoice(id, formData) {
    const { customerId, amount, status } = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$ui$2f$invoices$2f$buttons$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["UpdateInvoice"].parse({
        customerId: formData.get('customerId'),
        amount: formData.get('amount'),
        status: formData.get('status')
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d095e5b._.js.map